...
export default function WhatsAppButton() {
  ...
  // REPLACE: Update the phone number in .env.local → NEXT_PUBLIC_WHATSAPP_NUMBER
  const phone   = process.env.NEXT_PUBLIC_WHATSAPP_NUMBER || '254700000000'
  const message = encodeURIComponent(
    'Hello Oyugis Le Grand Hotel! I would like to make an enquiry.'
  )
      ...
      <AnimatePresence>
        {showTooltip && (
          <motion.div
            ...
            className="bg-hotel-dark text-white text-sm px-4 py-2.5 rounded-lg shadow-lg
